...
@Component
@EnableScheduling
public class UpTaskPKG extends UpAndDownTask {

    private Logger logger = LoggerFactory.getLogger(UpTaskPKG.class);

    final String pengingList_upload_pkg = RedisQueueType.PENG_UP_PKG.getCode();
    final String doingList_upload_pkg = RedisQueueType.DOING_UP_PKG.getCode();
    ...
    class Worker implements Callable<Boolean> {
        ...
        public Boolean call() throws Exception {
            ...
            RReadWriteLock readWriteLock = redissonService.getRWLock("Upload_" + packName);
            ...
            try {
                ...
                if (locked) {
                    ...
                    if (FileConfigUtil.ISCENTER) {
                        pkgUploaderManager.mainUploadPackage(ExchangeNodeType.MAIN, packName, null, null, paramMap);
                    } else {
