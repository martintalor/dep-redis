...
public class DateUtils {
    ...
    public static final String DATE_TIME_PATTERN_D = "yyyyMMddHHmmss";
    ...
    public static String sysdate()  {
        String sysDate = "";
        try {
            sysDate = dateFormat(new Date(),DATE_TIME_PATTERN);
    ...
    public static String sysdateD()  {
        String sysDate = "";
        try {
            sysDate = dateFormat(new Date(),DATE_TIME_PATTERN_D);
        } catch (ParseException e) {
            // 日期转换错误
        }
        return  sysDate;
     ...
     * @return date String
     */
    public static String getTodaySN()  {
        String date = "";
        try {
            date = dateFormat(new Date(),DATE_PATTERN_D);
        } catch (ParseException e) {
            // 转换错误
        }
        return  date;
    ...
    public static String getDateTime()  {
        String dateTime = "";
        try {
            dateTime = dateFormat(new Date(),DATE_TIME_PATTERN);
        } catch (ParseException e) {
            // 转换错误
        }
        return  dateTime;
    ...
    public static BigDecimal endTest(long startTime) {
        long endTime   = System.currentTimeMillis();
        BigDecimal excTime = BigDecimal.valueOf((endTime - startTime) / 1000);
        return excTime;
    }
    //获取本周的开始时间
    ...
    public static void main(String[] args) throws Exception {
          long s =  startTest();
          Thread.sleep(1000);
          System.out.println( endTest(s) );

//        System.out.println(  sysdate() );
//        System.out.println(dateTimeToDate(new Date()));
//        System.out.println(getToday());
//        System.out.println(getTodaySN());
